  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        <Button size="sm" disabled><Plus size={13} />New Engagement</Button>
      </div>
      <Card>
        <CardHeader>
        ...
        <DataTable columns={COLUMNS} rows={[]} emptyMessage="No engagements yet. Create your first engagement to get started." />
      </Card>
    </div>
  )
}
