  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card>
          <CardHeader><div className="flex items-center gap-2"><Brain size={14} className="text-accent" /><CardTitle>Intel Query</CardTitle></div></CardHeader>
        ...
        <Card className="lg:col-span-2">
          ...
          <DataTable columns={COLUMNS} rows={[]} emptyMessage="No saved intel. Query the threat intelligence engine to populate this list." />
        </Card>
      </div>
    </div>
  )
