  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-3 px-4 py-3 bg-surface-2 border border-border rounded">
        ...
        <p className="font-mono text-xs text-text-muted">Recon module logic is coming in Segment 2. The interface is ready — wire-up pending.</p>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card>
          <CardHeader><div className="flex items-center gap-2"><Radar size={14} className="text-accent" /><CardTitle>Recon Configuration</CardTitle></div></CardHeader>
        ...
        <Card className="lg:col-span-2 flex flex-col min-h-[400px]">
          <CardHeader><CardTitle>Recon Output</CardTitle></CardHeader>
