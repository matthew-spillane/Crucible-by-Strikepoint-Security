        ...
        <div className="flex flex-col gap-4">
          <Card>
            ...
            <div className="flex flex-col gap-4">
              <Input
                label="Target"
                placeholder="https://target.com or 10.0.0.0/24"
                value={target}
                onChange={(e) => setTarget(e.target.value)}
                mono
              />
              <Textarea
                label="Scope Notes / Rules of Engagement"
                placeholder="Describe in-scope assets, out-of-scope paths, rate limits, authorized windows..."
                value={scopeNotes}
        ...
        <Card className="lg:col-span-2 flex flex-col min-h-[500px]">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle>Agentic Reasoning Stream</CardTitle>
            </div>
          ...
          <div className="flex-1 bg-surface-2 rounded border border-border p-4 overflow-y-auto font-mono text-xs">
            <div className="flex flex-col items-center justify-center h-full gap-3 text-center">
              ...
              <p className="text-text-muted">
                Reasoning stream will appear here once Auto Mode is active.
              </p>
              <p className="text-text-muted/60 text-[10px]">
                Claude's step-by-step analysis, tool calls, and findings will stream in real time.
              </p>
            </div>
          </div>
