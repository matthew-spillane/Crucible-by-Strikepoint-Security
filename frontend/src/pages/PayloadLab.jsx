        ...
        <Card>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <select
                className="bg-surface-2 border border-border rounded px-3 py-2 text-sm font-body text-text-primary focus:outline-none focus:border-accent opacity-50 cursor-not-allowed"
                disabled
                value={type}
